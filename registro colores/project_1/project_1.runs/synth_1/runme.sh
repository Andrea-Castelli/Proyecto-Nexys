...
HD_PWD='C:/Users/Jesusico/Downloads/UNI/Proyecto-Nexys/registro colores/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GENERADOR_RGB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GENERADOR_RGB.tcl
