...
HD_PWD='C:/Users/Jesusico/Downloads/UNI/Proyecto-Nexys/registro colores/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GENERADOR_RGB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GENERADOR_RGB.tcl -notrace
